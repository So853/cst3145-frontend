let store = new Vue({
    ...
    methods: {
        ...
        searchLessons: function () {
            ...
            fetch("https://cst3145-backend.herokuapp.com/collection/lessons/" + this.searchTxt).then(
                function (response) {
                    response.json().then(
                        function (data) {
                            console.log(data);
        ...
        checkOut: function () {
            ...
            fetch('https://cst3145-backend.herokuapp.com/collection/orders', {
            ...
            for (let index = 0; index < this.cartItems.length; index++) {
                ...
                fetch(`https://cst3145-backend.herokuapp.com/collection/lessons/${lesson._id}`, {
    ...
    created: function () {
        fetch("https://cst3145-backend.herokuapp.com/collection/lessons").then(
            function (response) {
                response.json().then(
                    function (data) {
                        console.log(data);
